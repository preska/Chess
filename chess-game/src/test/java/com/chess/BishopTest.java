...
public class BishopTest {
    ...
    public void testMoveValidity() {
        ...
        possibleMoves = Move.generatePossibleMovesBishop(currPlayer, possibleMoves, srcCoord, board.getBoard());
    ...
    public void testCapture() {
        ...
        Bishop b = new Bishop(new Point2D.Double(3, 3), 0);
